...
public class PathMenu extends FrameLayout implements OnTouchListener {
    ...
    private static final int[] ITEM_DRAWABLES = {R.drawable.ic_email,R.drawable.ic_email, R.drawable.ic_email, R.drawable.ic_email, R.drawable.ic_email, R.drawable.ic_email};
    ...
    private void applyAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            float fromDegrees = a.getFloat(jp.co.recruit_lifestyle.android.floatingview.R.styleable.ArcLayout_fromDegrees,
                    PathMenuLayout.DEFAULT_FROM_DEGREES);
            float toDegrees = a.getFloat(jp.co.recruit_lifestyle.android.floatingview.R.styleable.ArcLayout_toDegrees,
            ...
            int newChildSize = a.getDimensionPixelSize(
                    jp.co.recruit_lifestyle.android.floatingview.R.styleable.ArcLayout_childSize, defaultChildSize);
